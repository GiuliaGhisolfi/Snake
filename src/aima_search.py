...
romania_map = UndirectedGraph(dict(
    ...
    Craiova=dict(Dromax_len_repair=120, Rimnicu=146, Pitesti=138),
    Dromax_len_repair=dict(Mehadia=75),
...
romania_map.locations = dict(
    ...
    Dromax_len_repair=(165, 299), Eforie=(562, 293), Fagaras=(305, 449),
